...
export const mockRecommendations: AnalysisRecommendationsResponse = {
  analysisId: mockBlogAnalysis.analysisId,
  campaigns: [
    {
      id: 5,
  ...
  bloggers: [
    {
      ...
      badge: '인플루언서',
      postTitle: '성수 신상 브런치 카페 솔직 후기',
      postUrl: 'https://example.com/posts/food-1',
      blogUrl: 'https://example.com/blogs/food-explorer',
      likeCount: 120,
      overallScore: 96,
      thumbnailUrl: null,
    },
    {
      ...
      handle: '@cafe_note',
      badge: '인플루언서',
      postTitle: '연남동 디저트 투어 루트 정리',
      postUrl: 'https://example.com/posts/food-2',
      blogUrl: 'https://example.com/blogs/cafe-note',
      likeCount: 98,
      overallScore: 93,
      thumbnailUrl: null,
    },
    {
      ...
      handle: '@seoul_bite',
      badge: '인플루언서',
      postTitle: '합정 데이트 코스 맛집 모음',
      postUrl: 'https://example.com/posts/food-3',
      blogUrl: 'https://example.com/blogs/seoul-bite',
      likeCount: 87,
      overallScore: 90,
      thumbnailUrl: null,
    },
